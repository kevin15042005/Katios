  ...
  const obtenerCartas = async () => {
    try {
      const res = await axios.get(
        `${import.meta.env.VITE_API_URL}/cartas/obtener_Cartas_Punto/3`,
      );
  ...
  return (
    <section className="min-h-screen bg-[#360707] ">
      ...
      <div className="col-span-1 md:col-span-2 flex justify-center my-10">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3976.439566941072!2d-74.13914230321045!3d4.693429800000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f9d0040102a57%3A0x3c67eecdedd123ea!2zS2F0w61vcyBQdWVudGUgYcOpcmVv!5e0!3m2!1ses-419!2sco!4v1780518575869!5m2!1ses-419!2sco"
          style={{
            width: "90%",
            margin: "0",
            maxWidth: "800px",
